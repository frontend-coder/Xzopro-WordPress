...
function custom_theme_options() {
  ...
  $custom_settings = array(
    'contextual_help' => array(
      'content'       => array(
        array(
          ...
          'title'     => __( 'Опции темы', 'theme-text-domain' ),
          'content'   => '<p>' . __( 'Здесь вы найдете помошь в настройке темы!', 'theme-text-domain' ) . '</p>'
        )
      ),
    ...
    'sections'        => array(
      array(
        'id'          => 'logotype_type',
        'title'       => __( 'Логотип сайта', 'theme-text-domain' )
      )
    ),
    ...
    'settings'        => array(
      ...
      array(
        'id'          => 'logo_upload',
        'label'       => __( 'Загрузите логотип на сайт', 'theme-text-domain' ),
        'desc'        => sprintf( __( 'Выберите файл изображения на вашем компьютре, которые будет подставлено на место логотипа. Размер файла 142 пикселя х 38 пикселя.', 'theme-text-domain' ), apply_filters( 'ot_upload_text', __( 'Загрузить в настройки темы', 'theme-text-domain' ) ), 'FTP' ),
        'type'        => 'upload',
        'section'     => 'logotype_type',
        'rows'        => '',
        'post_type'   => '',
        'taxonomy'    => '',
        'min_max_step'=> '',
        ...
        'operator'    => 'and'
            ...
            array(
        'id'          => 'header_button_two_on_off',
        'label'       => __( 'Включить/выключить отображения кнопки о нас', 'theme-text-domain' ),
        'desc'        => sprintf( __( 'C помощью этого переключателя вы можете сключить/ отключить отображение кнопки о нас в шапке сайта. Сохраните положение переключателя в позиции включено или выключено.', 'theme-text-domain' ), '<code>on</code>', '<code>off</code>' ),
        'std'         => 'off',
        'type'        => 'on-off',
        'section'     => 'logotype_type',
        'rows'        => '',
        ...
        'operator'    => 'and'
         ...
         array(
        'id'          => 'header_button_one_on_off',
        'label'       => __( 'Включить/выключить отображения кнопки нашм услуги', 'theme-text-domain' ),
        'desc'        => sprintf( __( 'C помощью этого переключателя вы можете сключить/ отключить отображение кнопки наши услуги в шапке сайта. Сохраните положение переключателя в позиции включено или выключено.', 'theme-text-domain' ), '<code>on</code>', '<code>off</code>' ),
        'std'         => 'off',
        'type'        => 'on-off',
        'section'     => 'logotype_type',
        'rows'        => '',
...
// Примеры настроек, которые нужно будет удалить
